  ...
  return (
    <>
      ...
      <RigidBody position={[15, 0, 0]} colliders={false}>
        <Text scale={0.5} color="black" maxWidth={10} textAlign="center" position={[0, 1, 0]} rotation={[0, -Math.PI / 2, 0]}>
          mass: 1
        </Text>
      ...
      <RigidBody position={[15, 0, -2]} colliders={false}>
        <Text scale={0.5} color="black" maxWidth={10} textAlign="center" position={[0, 1.5, 0]} rotation={[0, -Math.PI / 2, 0]}>
          mass: 3.375
        </Text>
      ...
      <RigidBody position={[15, 0, -5]} colliders={false}>
        <Text scale={0.5} color="black" maxWidth={10} textAlign="center" position={[0, 2, 0]} rotation={[0, -Math.PI / 2, 0]}>
          mass: 8
        </Text>
